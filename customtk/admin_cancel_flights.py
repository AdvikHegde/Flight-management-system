...
def admin_cancel_flights():
  ...
  #GENERATE DETAILS
  generate_details_button=Button(flight_info_frame,text="GENERATE DETAILS",font=("bold",10),height=2,width=15)
  generate_details_button.grid(row=0,column=2,padx=20,pady=5,rowspan=2)
  ...
  airline_label.grid(row=2,column=1,padx=20,pady=5)
  airline_label_combobox.grid(row=3,column=1,padx=20,pady=5)
  ...
  passenger_label.grid(row=2,column=2,padx=20,pady=5)
  passenger_entry.grid(row=3,column=2,padx=20,pady=5)
  ...
  source_label.grid(row=4,column=1,padx=20,pady=5)
  source_entry.grid(row=5,column=1,padx=20,pady=5)
  ...
  destination_label.grid(row=4,column=2,padx=20,pady=5)
  destination_entry.grid(row=5,column=2,padx=20,pady=5)
  ...
  status_entry=ttk.Combobox(runningstatus_info_frame,values=["Delayed","Cancelled","On Time"],width=20)
  status_label.grid(row=8,column=1,padx=20,pady=5)
  status_entry.grid(row=9,column=1,padx=20,pady=5)

  
  
  cancel_flight_button=Button(parent_frame,text="CANCEL FLIGHT",command=lambda:cancel_flight(),width=20,height=2)
  cancel_flight_button.grid(row=9,column=2,columnspan=2,padx=20,pady=20)
